...
class _expageState extends State<expage> {
  ...
  static List<String> url = [
    'https://th.bing.com/th/id/OIP.iSebuYpfhQG14qgscrlV1QHaIg?w=186&h=213&c=7&r=0&o=5&dpr=1.5&pid=1.7',
  ...
  final List<FirstTest> testdata = List.generate(
      testword.length,
      (index) => FirstTest('${testword[index]}', '${url[index]}',
          '${testword[index]} Description...'));
  @override
