...
class AddAccountFormStudent extends StatefulWidget {
  const AddAccountFormStudent({Key? key}) : super(key: key);

  @override
  State<AddAccountFormStudent> createState() => _AddAccountFormState();
}

class _AddAccountFormState extends State<AddAccountFormStudent> {
  String gender = '';

  var idController = TextEditingController();
  var fatherIdController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            const Text("إنشاء حساب جديد للطالب",
              style: TextStyle(
                color: Colors.white,
                fontFamily: "Tajawal",
                fontSize: 40,
    ...
    return ElevatedButton(
      ...
      onPressed: () {
        if (idController.text.isEmpty ||
            fatherIdController.text.isEmpty ||
            gender.isEmpty ||
  ...
  SizedBox buildFatherIdInputField() {
    return SizedBox(
      width: MediaQuery.of(context).size.width/1.55,
      child: Row(
        children: [
  ...
  SizedBox buildIdCardInputField() {
    return SizedBox(
      width: MediaQuery.of(context).size.width/1.55,
      child: Row(
        children: [
  ...
  SizedBox buildDateOfBirthInputField() {
    return SizedBox(
      width: MediaQuery.of(context).size.width/1.55,
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceAround,
  ...
  SizedBox buildProblemInputField() {
    return SizedBox(
      width: MediaQuery.of(context).size.width/1.55,
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceAround,
